This is CodeBook that describes the variables, the data, and any transformations or work that you performed to clean up the data 
...
Subject : Volunteer on whom test is performed
ActivityLabel: Label of Activity. It can have values LAYING, SITTING, STANDING, WALKING, WALKING_DOWNSTAIRS, WALKING_UPSTAIRS
Mean of various tests with mean and standard deviation
